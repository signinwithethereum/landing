...
export const metadata: Metadata = {
  title: "Sign in with Ethereum - Open standard for authentication with Ethereum accounts",
  ...
  keywords: ["Ethereum", "authentication", "SIWE", "Sign in with Ethereum", "crypto", "web3", "wallet"],
