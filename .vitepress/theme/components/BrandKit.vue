...
const SWATCHES = [
  { name: 'Accent', hex: '#7f00f6', note: 'The one constant. Identical in both themes.' },
  ...
  { name: 'Accent, readable', hex: '#6b21d6', note: 'And #b184ff inverted. For text and links — the accent itself is unreadable on both grounds.' }
]
</script>
